...
import 'package:climategame/utils/circular_percent_indicator.dart';
                  ...
                  children: <Widget>[
                    CircularPercentIndicator(
                      ...
                      footer: Container(
                        ...
                        decoration: boxDecorations(showShadow: true, bgColor: quiz_white, radius: 8),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      decoration: boxDecorations(radius: 10, bgColor: quiz_color_facebook, showShadow: true),
                    ...
                    Container(
                      ...
                      width: MediaQuery.of(context).size.width * 0.15,
                      height: MediaQuery.of(context).size.width * 0.15,
                      decoration: boxDecorations(radius: 10, bgColor: quiz_form_google, showShadow: true),
                    ...
                    Container(
                      ...
                      width: MediaQuery.of(context).size.width * 0.15,
                      height: MediaQuery.of(context).size.width * 0.15,
                      decoration: boxDecorations(radius: 10, bgColor: quiz_color_message, showShadow: true),
                    ...
                    Container(
                      ...
                      width: MediaQuery.of(context).size.width * 0.15,
                      height: MediaQuery.of(context).size.width * 0.15,
                      decoration: boxDecorations(radius: 10, bgColor: quiz_color_twitter, showShadow: true),
