            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  decoration: boxDecorations(bgColor: quiz_white, color: quiz_white, showShadow: true, radius: 10),
                  child: Column(
                    children: <Widget>[
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: NB.primaryTextStyle(size: 20, color: quiz_textColorPrimary),
                ...
                Container(
                  ...
                  child: quizButton(
                    ...
                    onPressed: () {
                      setState(() {
                        Navigator.of(context).pop();
                        NB.toast(quiz_Password_Updated);
                      });
                    },
                  ),
                )
