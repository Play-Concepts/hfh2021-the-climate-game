...
import 'package:climategame/quiz/Screens/QuizSettings.dart';
    ...
    final imgview = Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            width: width,
            decoration: boxDecorations(radius: spacing_middle, bgColor: quiz_white, showShadow: false),
          ...
          selectedPos == 1
              ? Container(
                  decoration: boxDecorations(bgColor: quiz_white, radius: 10, showShadow: true),
