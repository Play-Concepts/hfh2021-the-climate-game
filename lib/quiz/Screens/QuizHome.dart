...
import 'package:climategame/quiz/Screens/QuizDetails.dart';
import 'package:climategame/quiz/Screens/QuizNewList.dart';
import 'package:climategame/quiz/Screens/QuizSearch.dart';
...
class _QuizHomeState extends State<QuizHome> {
  ...
  void initState() {
    ...
    String pdaUrl = GetStorage(dkStore).read(dkPda);
    pdaName = pdaUrl.split(".").first;
  }
          ...
          children: <Widget>[
            SingleChildScrollView(
              ...
              child: Column(
                children: <Widget>[
                  SizedBox(height: 30),
                  text("Hello, $pdaName!", fontFamily: fontBold, fontSize: textSizeXLarge),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          decoration: boxDecorations(radius: 10, showShadow: false, bgColor: quiz_colorPrimary),
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) => GestureDetector(
                        onTap: () {
                          QuizDetails(mListings[index].quizName).launch(context);
                        },
...
class NewQuiz extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: boxDecorations(radius: 16, showShadow: true, bgColor: quiz_white),
      child: Column(
