...
import 'package:climategame/quiz/Screens/QuizChangePassword.dart';
import 'package:climategame/quiz/Screens/QuizContactUs.dart';
import 'package:climategame/quiz/Screens/QuizEditProfile.dart';
import 'package:climategame/quiz/Screens/QuizHelpCenter.dart';
import 'package:climategame/quiz/Screens/QuizUpdateEmail.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          quiz_lbl_setting,
          style: NB.primaryTextStyle(size: 18, fontFamily: fontMedium),
        ),
        leading: Icon(
          Icons.arrow_back,
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    SizedBox(height: 8),
                    Container(
                      decoration: BoxDecoration(color: quiz_white, borderRadius: BorderRadius.circular(8), boxShadow: NB.defaultBoxShadow()),
                    ...
                    Text(
                      quiz_lbl_logout,
                      style: NB.boldTextStyle(color: quiz_colorPrimary, size: 18),
                    ).paddingAll(16).onTap(() {
                      NB.finish(context);
                    })
                  ],
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                ...
                Text(
                  info,
                  style: NB.primaryTextStyle(color: quiz_textColorSecondary, size: 14),
                )
              ],
            ),
          ],
